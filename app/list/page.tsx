...
export default function List() {
  ...
  return (
    <section className="my-5 mx-4">
      <h1 className="text-blue font-semibold text-3xl mb-2">
        Liste des entreprises
      </h1>
      <p className="text-lg">
        *<span className="font-bold">GAFAM</span>: Géants du web{" "}
        <span className="font-bold">G</span>oogle,{" "}
        <span className="font-bold">A</span>pple,{" "}
        <span className="font-bold">F</span>acebook,{" "}
        <span className="font-bold">A</span>mazon et{" "}
      ...
      <div className="flex items-center gap-4 text-lg mt-4">
        ...
        <button
          ...
          className={`font-semibold px-3 rounded-md ${
            !isReverseOrder ? "bg-blue text-white" : "border-2 border-blue"
          }`}
        >
          De A à G
        </button>
