        ...
        <section className="features container mx-auto max-w-screen-xl">
            ...
            <div className="flex flex-col gap-4 md:flex-row mt-5">
                <div className="md:w-1/3 feature rounded shadow-lg bg-white px-4 py-5 flex flex-col items-center content-center my-5 gap-2">
                    <Image alt="Icône de bâtiments" src="/list-entreprises.png" width={'112'} height={'112'}/>
                ...
                <div className="md:w-1/3 feature rounded shadow-lg bg-white px-4 py-5 flex flex-col items-center content-center my-5 gap-2">
                    <Image alt="Icône illustrant une fuite de données" src="/data-leak.png" width={'112'} height={'112'}/>
                ...
                <div className="md:w-1/3 feature rounded shadow-lg bg-white px-4 py-5 flex flex-col items-center content-center my-5 gap-2">
                    <Image alt="Icône illustrant un template d'email" src="/template-mail.png" width={'112'} height={'112'}/>
